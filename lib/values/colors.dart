...
final Color accentColor = Color(0xFF44992D);
final Color accentLightColor = Color(0xFF44992D);

final Color lighterAccentColor = Color(0xFF44D064);

final Color primaryColor = Color(0xFF21252b);
...
final Color backgroundColorDark = Color(0xFF121212);
final Color backgroundColorDarkLighter = Color(0xFF3C3C3C);
